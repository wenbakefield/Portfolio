    ...
    <Container fluid className="about-section">
      ...
      <Container>
        <Row style={{ justifyContent: "center", padding: "10px" }}>
          ...
          >
            <h1 style={{ paddingBottom: "20px" }}>Who Am I?</h1>
            <Aboutcard />
          </Col>
          <Col
            md={5}
        ...
        <LanguageStack />
        <h1 className="project-heading"><strong className="purple">Frameworks</strong> I deploy with</h1>
        <FrameworkStack />
        <h1 className="project-heading"><strong className="purple">Software</strong> I depend on</h1>
        <SoftwareStack />
